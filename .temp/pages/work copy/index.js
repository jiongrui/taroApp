...
export default class Index extends Component {
  ...
  render() {
    return <View className="work">
        <ScrollView scrollY={!this.state.showPopup} className="list">
          {this.state.works.map((work, midx) => <View className="list-item" key={`work${midx}`}>
              <View className="img-list">
                <View className="img-box" onClick={this.handleShowPopup} data-midx={midx} id={midx}>
        ...
        {this.state.showPopup && <Popup list={this.state.works} onHandleHidePopup={this.handleHidePopup} curId={this.state.curIndex} popupStyle={this.state.popupStyle} />}
      </View>;
  }
}